...
def display():
    global cameraIndex, cow2wld, control_points, control_points_matrix, cow2wld_init, animStartTime, pickInfo
...
def onMouseButton(window,button, state, mods):
    global isDrag, V_DRAG, H_DRAG, control_points, control_points_matrix, myCurrentPos, animStartTime
    GLFW_DOWN=1;
    GLFW_UP=0;
...
def onMouseDrag(window, x, y):
    global isDrag,cursorOnCowBoundingBox, pickInfo, cow2wld, myCurrentPos
    if isDrag: 
